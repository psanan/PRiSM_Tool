# Quickly modified from solKz.c, taken from Underworld.
# Please see the original file for more explanation and context.
#
# Original source:
#
#libUnderworld/Underworld/SysTest/AnalyticPlugins/Velic_solKz/solKz.c
#https://github.com/underworldcode/underworld2
#commit ea248261c19de26ab64cd1b548843737addcbb3a
#September 3, 2019
#
# License information from original file:
#
#/*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*
#**                                                                                  **
...
#
# Converted by:
# - changing to a single function
# - changing double to Float64
# - changing int to Int32
# - expanding array inputs
# - returning a tuple of results instead of using output arguments
# - ignoreing some output arguments, only returning vx, vy, p
# - changing any remaining [i] to [i+1] for Julia's 1-based indexing
# - updating constants  M_PI --> pi
# - letting variable declarations be implicit
# - remove most comments
#

function evaluate_solKz(
    x::Float64,
    z::Float64,
    _sigma::Float64,
    _km::Float64,
    ...
    # Note several things were removed here:
    vx = sum2;
    vy = sum1;
    pressure = sum5;
    return pressure, vx, vy
end;
